...
magnituderet,magnitudeimage = cv2.threshold(sobelGrad ,40,255,cv2.THRESH_BINARY)
cv2.imshow("Magnitude",magnitudeimage)


cv2.imshow('custom_2d_convolution_gx.png',sobelxImage) 
cv2.imshow('custom_2d_convolution_gy.png',sobelyImage)
cv2.imshow('custom_2d_convolution_gradient.png',sobelGrad)
cv2.waitKey (0)
